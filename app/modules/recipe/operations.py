...
def create(
    id_category: int, name: int, preparation_time: int, description: str
) -> Recipe:
    recipe = Recipe(id_category, name, preparation_time, description)
    Recipe.save(recipe)
    return recipe
...
def update(recipe: Recipe, form: UpdateForm) -> Recipe:
...
def update_ingredient_rel(
    ingredient_rel: RecipeIngredient, form: UpdateIngredientRelForm
) -> RecipeIngredient:
...
def update_material_rel(
    material_rel: RecipeMaterial, form: UpdateMaterialRelForm
) -> RecipeMaterial:
